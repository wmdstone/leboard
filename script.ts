      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="sticky top-8">
             ...
             <div className="bg-background border border-border rounded-[2rem] p-6 mb-4 shadow-soft">
                {/* Preview: Navbar mini */}
                ...
                {/* Preview: Hero */}
                <div className="bg-card border border-border p-8 rounded-[1.5rem] shadow-soft relative overflow-hidden mb-6 flex flex-col justify-center min-h-[220px]">
                ...
                {/* Preview: Card */}
                <div className="bg-card rounded-[1.5rem] p-5 border border-border shadow-soft transition-all hover:border-primary/50 hover:shadow-primary-glow cursor-pointer group">
                  <div className="flex gap-4 items-center">
...
fs.writeFileSync('src/components/admin/AdminAppearanceTab.tsx', content);
